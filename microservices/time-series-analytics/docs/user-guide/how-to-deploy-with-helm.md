...
- Using pre-built helm charts:
    ...
    1. Download helm chart with the following command
        ...
        `helm pull oci://registry-1.docker.io/intel/time-series-analytics-microservice --version 1.1.0-2026.0-weekly`

    2. unzip the package using the following command

        `tar -xvzf time-series-analytics-microservice-1.1.0-2026.0-weekly.tgz`
