...
_args.add_argument(
    "-mi", "--model_index", help="Path to existing model_index.yaml file", required=False, type=str
)
_args.add_argument(
    "-o", "--output", help="Required. Path to output model_index.yaml file", required=True, type=str
)
_args.add_argument(
    "-a",
    "--all",
